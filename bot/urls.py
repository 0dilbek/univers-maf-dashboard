...
urlpatterns = [
    ...
    path('shop-prices/', views.shop_prices, name='shop_prices'),
    ...
    path('errors/', views.error_logs_list, name='error_logs'),
    path('errors/<int:error_id>/', views.error_log_detail, name='error_log_detail'),
